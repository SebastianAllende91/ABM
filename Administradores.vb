...
Public Class Administradores
    ...
    Sub buscar(ByVal condicion As String)
        ...
        Dim da As New SqlDataAdapter("SELECT TOP (100) PERCENT Id,apeynom from Administradores_Búsqueda where " & condicion & " order by Id", con)
    ...
    Sub CargarCamposClientes()
        ...
        Else
            ...
            Try
                ...
                Dim da As New SqlDataAdapter("SELECT ApellidoAdm as apellido,NombreAdm as nombres,[documento-Adm] as doc,DomicilioAdm as domicilio,PostalAdm as codigoPostal,LocalidadAdm as localidad,ProvinciaAdm as provincia,TeléfonosAdm as teléfonos,ComentariosAdm as comentarios,[E-Mail-Adm] as email,Cuit,Usuario,Clave from Administradores where Id=" & Val(lLegajo.Text), con)
                Dim ds As New DataSet
                da.Fill(ds, "Administradores")
                ...
                TextBox4.Text = ds.Tables("Administradores").Rows(0)("domicilio")
                TextBox5.Text = ds.Tables("Administradores").Rows(0)("codigoPostal")
                TextBox6.Text = ds.Tables("Administradores").Rows(0)("localidad")
                TextBox7.Text = ds.Tables("Administradores").Rows(0)("provincia")
                TextBox8.Text = ds.Tables("Administradores").Rows(0)("teléfonos")
                TextBox9.Text = ds.Tables("Administradores").Rows(0)("comentarios")
                TextBox10.Text = ds.Tables("Administradores").Rows(0)("email")
                TextBox11.Text = ds.Tables("Administradores").Rows(0)("cuit")
                TextBox12.Text = ds.Tables("Administradores").Rows(0)("usuario")
                TextBox13.Text = ds.Tables("Administradores").Rows(0)("clave")
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If MessageBox.Show("Está por ELIMINAR definitivamente al Administrador: " & TextBox1.Text.Trim.ToUpper & "?", "Eliminar Administrador", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then Exit Sub
        Try
            If SQL_Accion("delete from Administradores where Id=" & Val(lLegajo.Text)) = False Then
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If SQL_Accion("update Administradores set estado=" & IIf(CheckBox1.Checked, 1, 0) & ", apellidoAdm ='" & TextBox1.Text.Trim.ToUpper.Replace("'", "´") & "', nombreAdm='" & TextBox2.Text.Trim.ToUpper.Replace("'", "´") & "', [documento-Adm]=" & Val(TextBox3.Text.Trim.Replace(".", "").Replace(" ", "").Replace(",", "")) & ", domicilioAdm='" & TextBox4.Text.Trim.ToUpper.Replace("'", "´") & "', PostalAdm='" & TextBox5.Text.Trim.ToUpper.Replace("'", "´") & "', localidadAdm='" & TextBox6.Text.Trim.ToUpper.Replace("'", "´") & "', provinciaAdm='" & TextBox7.Text.Trim.ToUpper.Replace("'", "´") & "', teléfonosAdm='" & TextBox8.Text.Trim.ToUpper.Replace("'", "´") & "', [e-mail-Adm]='" & TextBox10.Text.Trim.ToUpper.Replace("'", "´") & "', fechanacimientoAdm=" & FechaSQL(DateTimePicker1.Value) & ", comentariosAdm='" & TextBox9.Text.Trim.ToUpper.Replace("'", "´") & "', cuit='" & TextBox11.Text.Trim.ToUpper.Replace("'", "´") & "', usuario='" & TextBox12.Text.Trim.ToUpper.Replace("'", "´") & "', clave='" & TextBox13.Text.Trim.ToUpper.Replace("'", "´") & "' where Id=" & VNum(lLegajo.Text)) = True Then
    ...
    Private Sub bNuevoAdmin_Click(sender As Object, e As EventArgs) Handles bNuevoAdmin.Click
        Try
            If SQL_Accion("insert into Administradores (apellidoAdm, nombreAdm, [documento-Adm],domicilioAdm, localidadAdm, teléfonosAdm, fechanacimientoAdm, comentariosAdm,[e-mail-Adm],estado,cuit,usuario,clave) values ('*****','*****',    0,   '',   '',     '',  getdate(),  '' ,   '' ,1,'','','') ") Then
