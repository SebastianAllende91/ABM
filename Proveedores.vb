...
Public Class Proveedores
    ...
    Sub buscar(ByVal condicion As String)
        ...
        Dim da As New SqlDataAdapter("SELECT TOP (100) PERCENT Id,apeynom from Proveedores_Búsqueda where " & condicion & " order by Id", con)
    ...
    Sub CargarCamposClientes()
        ...
        Else
            ...
            Try
                ...
                Dim da As New SqlDataAdapter("SELECT ApellidoProv as apellido,NombreProv as nombres,[documento-Prov] as doc,DomicilioProv as domicilio,PostalProv as codigoPostal,LocalidadProv as localidad,ProvinciaProv as provincia,TeléfonosProv as teléfonos,ComentariosProv as comentarios,[E-Mail-Prov] as email, Cuit,Usuario,Clave from Proveedores where Id=" & Val(lLegajo.Text), con)
                Dim ds As New DataSet
                da.Fill(ds, "Proveedores")
                ...
                TextBox4.Text = ds.Tables("Proveedores").Rows(0)("domicilio")
                TextBox5.Text = ds.Tables("Proveedores").Rows(0)("codigoPostal")
                TextBox6.Text = ds.Tables("Proveedores").Rows(0)("localidad")
                TextBox7.Text = ds.Tables("Proveedores").Rows(0)("provincia")
                TextBox8.Text = ds.Tables("Proveedores").Rows(0)("teléfonos")
                TextBox9.Text = ds.Tables("Proveedores").Rows(0)("comentarios")
                TextBox10.Text = ds.Tables("Proveedores").Rows(0)("email")
                TextBox11.Text = ds.Tables("Proveedores").Rows(0)("cuit")
                TextBox12.Text = ds.Tables("Proveedores").Rows(0)("usuario")
                TextBox13.Text = ds.Tables("Proveedores").Rows(0)("clave")
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If MessageBox.Show("Está por ELIMINAR definitivamente al Proveedor: " & TextBox1.Text.Trim.ToUpper & "?", "Eliminar Proveedor", MessageBoxButtons.YesNo, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.No Then Exit Sub
        Try
            If SQL_Accion("delete from Proveedores where Id=" & Val(lLegajo.Text)) = False Then
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If SQL_Accion("update proveedores set estado=" & IIf(CheckBox1.Checked, 1, 0) & ", apellidoProv ='" & TextBox1.Text.Trim.ToUpper.Replace("'", "´") & "', nombreProv='" & TextBox2.Text.Trim.ToUpper.Replace("'", "´") & "', [documento-Prov]=" & Val(TextBox3.Text.Trim.Replace(".", "").Replace(" ", "").Replace(",", "")) & ", domicilioProv='" & TextBox4.Text.Trim.ToUpper.Replace("'", "´") & "', PostalProv='" & TextBox5.Text.Trim.ToUpper.Replace("'", "´") & "', localidadProv='" & TextBox6.Text.Trim.ToUpper.Replace("'", "´") & "', provinciaProv='" & TextBox7.Text.Trim.ToUpper.Replace("'", "´") & "', teléfonosProv='" & TextBox8.Text.Trim.ToUpper.Replace("'", "´") & "', [e-mail-Prov]='" & TextBox10.Text.Trim.ToUpper.Replace("'", "´") & "', fechanacimientoProv=" & FechaSQL(DateTimePicker1.Value) & ", comentariosProv='" & TextBox9.Text.Trim.ToUpper.Replace("'", "´") & "', cuit='" & TextBox11.Text.Trim.ToUpper.Replace("'", "´") & "', usuario='" & TextBox12.Text.Trim.ToUpper.Replace("'", "´") & "', clave='" & TextBox13.Text.Trim.ToUpper.Replace("'", "´") & "' where Id=" & VNum(lLegajo.Text)) = True Then
    ...
    Private Sub bNuevoProveedor_Click(sender As Object, e As EventArgs) Handles bNuevoProveedor.Click
        Try
            If SQL_Accion("insert into Proveedores (apellidoProv, nombreProv, [documento-Prov],domicilioProv, localidadProv, teléfonosProv, fechanacimientoProv, comentariosProv,[e-mail-Prov],estado,cuit,usuario,clave) values ('*****','*****',    0,   '',   '',     '',  getdate(),  '' ,   '' ,1,'','','') ") Then


                buscar(" apeynom Like '**%' ")
                MsgBox("Se ha creado un nuevo registro para el Proveedores que desea ingresar, seleccione la línea nueva, cargue los datos y luego confirme con el botón 'Aceptar Cambios'.")
            End If
        Catch ex As Exception
            Console.WriteLine(ex.Message)
        End Try
